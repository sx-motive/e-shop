...
export default function PrivacyPolicy() {
  return (
    <main className="default privacy-policy">
      <section>
        ...
        <p>
          ...
          безопасности персональных данных, предпринимаемые rgfhgfg (далее –
          ...
          Оператор может получить о посетителях веб-сайта https://4646. 2.
          ...
          помощью средств вычислительной техники. 2.2. Блокирование персональных
          ...
          https://4646. 2.4. Информационная система персональных данных —
          ...
          определяемому Пользователю веб-сайта https://4646. 2.9. Персональные
          ...
          https://4646. 2.11. Предоставление персональных данных – действия,
          направленные на раскрытие персональных данных определенному лицу или
          определенному кругу лиц. 2.12. Распространение персональных данных –
          ...
          https://4646. 7.2. Также Оператор имеет право направлять Пользователю
          ...
          электронной почты gfhgfhg@gmail.com с пометкой «Отказ от уведомлений о
          ...
          специальные формы, расположенные на сайте https://4646 или
          ...
          электронной почты Оператора gfhgfhg@gmail.com с пометкой «Актуализация
          ...
          Оператора gfhgfhg@gmail.com с пометкой «Отзыв согласия на обработку
          ...
          почты gfhgfhg@gmail.com. 14.2. В данном документе будут отражены любые
